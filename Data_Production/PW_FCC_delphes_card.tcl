#############################################################################################################################
#												                            #
# This card provides the currently estimated specs for a proposed detector at a O(100 TeV) future circular hadron collider. #
# We have highly borrowed from the card created by Heather Gray and Filip Moortgat for FCC detector studies.		    #
# 									                                                    #
#############################################################################################################################
...
module Calorimeter Calorimeter {
  ...
  set ECalResolutionFormula {                     (abs(eta) <= 4.0) * sqrt(energy^2*0.01^2 + energy*0.10^2) + 
                            (abs(eta) > 4.0 && abs(eta) <= 6.0) * sqrt(energy^2*0.01^2  + energy*0.10^2)}
